...
export const BlockData = {
  ...
  [BlockType.GRASS]: { name: 'Grass', color: 0x5B8C3E, hardness: 0.6, transparent: false, solid: true, topColor: 0x5B8C3E, sideColor: 0x8B6B3E, bottomColor: 0x8B6B3E },
  [BlockType.DIRT]: { name: 'Dirt', color: 0x8B6B3E, hardness: 0.5, transparent: false, solid: true },
  [BlockType.STONE]: { name: 'Stone', color: 0x808080, hardness: 1.5, transparent: false, solid: true, drops: BlockType.COBBLESTONE },
  [BlockType.SAND]: { name: 'Sand', color: 0xDBC67B, hardness: 0.5, transparent: false, solid: true },
  [BlockType.WATER]: { name: 'Water', color: 0x3366AA, hardness: -1, transparent: true, solid: false },
  [BlockType.WOOD]: { name: 'Wood', color: 0x6B4226, hardness: 2.0, transparent: false, solid: true, topColor: 0x9B7B3E, sideColor: 0x6B4226, bottomColor: 0x9B7B3E },
  [BlockType.LEAVES]: { name: 'Leaves', color: 0x3A7D32, hardness: 0.2, transparent: true, solid: true },
  [BlockType.COBBLESTONE]: { name: 'Cobblestone', color: 0x6B6B6B, hardness: 2.0, transparent: false, solid: true },
  [BlockType.PLANKS]: { name: 'Planks', color: 0xB8945A, hardness: 2.0, transparent: false, solid: true },
  [BlockType.COAL_ORE]: { name: 'Coal Ore', color: 0x4A4A4A, hardness: 3.0, transparent: false, solid: true },
  [BlockType.IRON_ORE]: { name: 'Iron Ore', color: 0xA08070, hardness: 3.0, transparent: false, solid: true },
  [BlockType.GOLD_ORE]: { name: 'Gold Ore', color: 0xC0A040, hardness: 3.0, transparent: false, solid: true },
  [BlockType.DIAMOND_ORE]: { name: 'Diamond Ore', color: 0x60C0E0, hardness: 3.0, transparent: false, solid: true },
  [BlockType.BEDROCK]: { name: 'Bedrock', color: 0x333333, hardness: -1, transparent: false, solid: true },
  [BlockType.SNOW]: { name: 'Snow', color: 0xF0F0F0, hardness: 0.5, transparent: false, solid: true },
  [BlockType.ICE]: { name: 'Ice', color: 0xA0D0F0, hardness: 0.5, transparent: true, solid: true },
  [BlockType.CLAY]: { name: 'Clay', color: 0xA0A0B0, hardness: 0.6, transparent: false, solid: true },
  [BlockType.GRAVEL]: { name: 'Gravel', color: 0x909090, hardness: 0.6, transparent: false, solid: true },
  [BlockType.CRAFTING_TABLE]: { name: 'Crafting Table', color: 0x9B7B3E, hardness: 2.5, transparent: false, solid: true, topColor: 0xB08840, sideColor: 0x9B7B3E },
  [BlockType.FURNACE]: { name: 'Furnace', color: 0x7A7A7A, hardness: 3.5, transparent: false, solid: true, sideColor: 0x5A5A5A },
  [BlockType.GLASS]: { name: 'Glass', color: 0xD0E8F0, hardness: 0.3, transparent: true, solid: true, thin: 'z' },
  [BlockType.BRICK]: { name: 'Brick', color: 0xA04030, hardness: 2.0, transparent: false, solid: true },
  [BlockType.OBSIDIAN]: { name: 'Obsidian', color: 0x1A0A2E, hardness: 10, transparent: false, solid: true },
  [BlockType.TORCH]: { name: 'Torch', color: 0xFFA500, hardness: 0.0, transparent: true, solid: false },
  [BlockType.SANDSTONE]: { name: 'Sandstone', color: 0xD4C476, hardness: 0.8, transparent: false, solid: true },
  // New blocks
  [BlockType.LAVA]: { name: 'Lava', color: 0xFF4400, hardness: -1, transparent: true, solid: false },
  [BlockType.MOSSY_COBBLESTONE]: { name: 'Mossy Cobblestone', color: 0x5B6B4B, hardness: 2.0, transparent: false, solid: true },
  [BlockType.STONE_BRICK]: { name: 'Stone Brick', color: 0x7A7A7A, hardness: 1.5, transparent: false, solid: true },
  [BlockType.MOSSY_STONE_BRICK]: { name: 'Mossy Stone Brick', color: 0x5A6A5A, hardness: 1.5, transparent: false, solid: true },
  [BlockType.CRACKED_STONE_BRICK]: { name: 'Cracked Stone Brick', color: 0x6A6A6A, hardness: 1.5, transparent: false, solid: true },
  [BlockType.JUNGLE_WOOD]: { name: 'Jungle Wood', color: 0x6B5030, hardness: 2.0, transparent: false, solid: true, topColor: 0x8B7040, sideColor: 0x6B5030, bottomColor: 0x8B7040 },
  [BlockType.JUNGLE_LEAVES]: { name: 'Jungle Leaves', color: 0x2A6B22, hardness: 0.2, transparent: true, solid: true },
  [BlockType.BIRCH_WOOD]: { name: 'Birch Wood', color: 0xD0C8B0, hardness: 2.0, transparent: false, solid: true, topColor: 0xC0B898, sideColor: 0xD0C8B0, bottomColor: 0xC0B898 },
  [BlockType.BIRCH_LEAVES]: { name: 'Birch Leaves', color: 0x5A9A42, hardness: 0.2, transparent: true, solid: true },
  [BlockType.SPRUCE_WOOD]: { name: 'Spruce Wood', color: 0x4A3520, hardness: 2.0, transparent: false, solid: true, topColor: 0x6A5530, sideColor: 0x4A3520, bottomColor: 0x6A5530 },
  [BlockType.SPRUCE_LEAVES]: { name: 'Spruce Leaves', color: 0x2A4A22, hardness: 0.2, transparent: true, solid: true },
  [BlockType.ACACIA_WOOD]: { name: 'Acacia Wood', color: 0x9A5A30, hardness: 2.0, transparent: false, solid: true, topColor: 0x8A6A40, sideColor: 0x9A5A30, bottomColor: 0x8A6A40 },
  [BlockType.ACACIA_LEAVES]: { name: 'Acacia Leaves', color: 0x6A9A32, hardness: 0.2, transparent: true, solid: true },
  [BlockType.MUSHROOM_BLOCK]: { name: 'Mushroom Block', color: 0xAA3030, hardness: 0.2, transparent: false, solid: true },
  [BlockType.MUSHROOM_STEM]: { name: 'Mushroom Stem', color: 0xD0C8B8, hardness: 0.2, transparent: false, solid: true },
  [BlockType.MYCELIUM]: { name: 'Mycelium', color: 0x7A6A80, hardness: 0.6, transparent: false, solid: true, topColor: 0x8A7A90, sideColor: 0x8B6B3E, bottomColor: 0x8B6B3E },
  [BlockType.PODZOL]: { name: 'Podzol', color: 0x6A5030, hardness: 0.6, transparent: false, solid: true, topColor: 0x6A5030, sideColor: 0x8B6B3E, bottomColor: 0x8B6B3E },
  [BlockType.RED_SAND]: { name: 'Red Sand', color: 0xC4783C, hardness: 0.5, transparent: false, solid: true },
  [BlockType.TERRACOTTA]: { name: 'Terracotta', color: 0xBA6B44, hardness: 1.25, transparent: false, solid: true },
  [BlockType.PACKED_ICE]: { name: 'Packed Ice', color: 0x8AB8E0, hardness: 0.5, transparent: false, solid: true },
  [BlockType.BLUE_ICE]: { name: 'Blue Ice', color: 0x6090D0, hardness: 2.8, transparent: false, solid: true },
  [BlockType.SOUL_SAND]: { name: 'Soul Sand', color: 0x5A4A3A, hardness: 0.5, transparent: false, solid: true },
  [BlockType.NETHERRACK]: { name: 'Netherrack', color: 0x8A3030, hardness: 0.4, transparent: false, solid: true },
  [BlockType.GLOWSTONE]: { name: 'Glowstone', color: 0xFFDD80, hardness: 0.3, transparent: false, solid: true },
  [BlockType.CHEST]: { name: 'Chest', color: 0x9B7B3E, hardness: 2.5, transparent: false, solid: true, topColor: 0xA08840, sideColor: 0x9B7B3E },
  [BlockType.BOOKSHELF]: { name: 'Bookshelf', color: 0xB8945A, hardness: 1.5, transparent: false, solid: true, sideColor: 0x8A4A2A },
  [BlockType.COBWEB]: { name: 'Cobweb', color: 0xE0E0E0, hardness: 4.0, transparent: true, solid: false },
  [BlockType.IRON_BLOCK]: { name: 'Iron Block', color: 0xD0D0D0, hardness: 5.0, transparent: false, solid: true },
  [BlockType.GOLD_BLOCK]: { name: 'Gold Block', color: 0xFFD700, hardness: 3.0, transparent: false, solid: true },
  [BlockType.DIAMOND_BLOCK]: { name: 'Diamond Block', color: 0x60E0F0, hardness: 5.0, transparent: false, solid: true },
  [BlockType.EMERALD_ORE]: { name: 'Emerald Ore', color: 0x60A060, hardness: 3.0, transparent: false, solid: true },
  [BlockType.EMERALD_BLOCK]: { name: 'Emerald Block', color: 0x30D030, hardness: 5.0, transparent: false, solid: true },
  [BlockType.WOOL]: { name: 'Wool', color: 0xF0F0F0, hardness: 0.8, transparent: false, solid: true },
  [BlockType.HAY_BALE]: { name: 'Hay Bale', color: 0xC8A830, hardness: 0.5, transparent: false, solid: true },
  [BlockType.TNT]: { name: 'TNT', color: 0xCC2222, hardness: 0.0, transparent: false, solid: true, sideColor: 0xCC2222, topColor: 0xAA1111 },
  [BlockType.LADDER]: { name: 'Ladder', color: 0x9B7B3E, hardness: 0.4, transparent: true, solid: false },
  [BlockType.FENCE]: { name: 'Fence', color: 0xB8945A, hardness: 2.0, transparent: true, solid: true },
  [BlockType.DOOR]: { name: 'Door', color: 0x8B6B3E, hardness: 3.0, transparent: true, solid: true, thin: 'z', topColor: 0x7A5A2D, sideColor: 0x6B4A1D },
  [BlockType.REDSTONE_ORE]: { name: 'Redstone Ore', color: 0xA04040, hardness: 3.0, transparent: false, solid: true },
  [BlockType.LAPIS_ORE]: { name: 'Lapis Ore', color: 0x4060A0, hardness: 3.0, transparent: false, solid: true },
  [BlockType.LAPIS_BLOCK]: { name: 'Lapis Block', color: 0x2050A0, hardness: 3.0, transparent: false, solid: true },
  [BlockType.QUARTZ]: { name: 'Quartz', color: 0xF0E8E0, hardness: 0.8, transparent: false, solid: true },
  [BlockType.PRISMARINE]: { name: 'Prismarine', color: 0x4A9A8A, hardness: 1.5, transparent: false, solid: true },
  [BlockType.SEA_LANTERN]: { name: 'Sea Lantern', color: 0xB0E0E8, hardness: 0.3, transparent: false, solid: true },
  [BlockType.CORAL]: { name: 'Coral', color: 0xE04080, hardness: 0.0, transparent: true, solid: true },
  [BlockType.BAMBOO]: { name: 'Bamboo', color: 0x6A9A30, hardness: 1.0, transparent: true, solid: true },
};
